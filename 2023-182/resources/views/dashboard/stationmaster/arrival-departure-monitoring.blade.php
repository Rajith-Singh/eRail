                ...
                <div class="container">
                    <div class="row">
                        ...
                        <form action="/stationmaster/predict" method="post">
                            @csrf
                            <br> 
                            train: <input type="text" value="" name="train">
                            <br>
                            Arrival: <input type="time" value="" name="arrival">
                            <br> 
                            Crossing Time: <input type="time" value="" name="crossing_time">
                            <br>
                            <input type="text" value="17" name="code" readonly>
