                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="/control-unit" class="nav-item nav-link">Live Crossing</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="img-fluid" src="img/background-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            <h5 class="text-primary text-uppercase mb-md-3">Railway Conceptual Modernization and Expansion System</h5>
                            <h1 class="display-3 text-white mb-md-4">eRail</h1>
                            <a href="" class="btn btn-primary">Get A Quote</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid" src="img/background-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-primary text-uppercase mb-md-3">Revolutionizing Railways</h5>
                            <h1 class="display-3 text-white mb-md-4">eRail</h1>
                            <a href="" class="btn btn-primary">Get A Quote</a>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    <img class="img-fluid" src="img/background-3.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-primary text-uppercase mb-md-3">Railway Conceptual Modernization and Expansion System</h5>
                            <h1 class="display-3 text-white mb-md-4">eRail</h1>
                ...
                <div class="carousel-item">
                    <img class="img-fluid" src="img/background-4.jpg" alt="Image">
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-primary text-uppercase mb-md-3">Revolutionizing Railways</h5>
                            <h1 class="display-3 text-white mb-md-4">eRail</h1>
            ...
            <div class="col-lg-4 p-0">
                <div class="contact-info-item d-flex align-items-center justify-content-center bg-primary text-white py-4 py-lg-0">
                    ...
                    <div class="">
                        ...
                        <p class="m-0">P.O. Box 355, <br> Railway Head Quarters, <br> Maradana, Colombo 10</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 p-0">
                <div class="contact-info-item d-flex align-items-center justify-content-center bg-secondary text-white py-4 py-lg-0">
                    ...
                    <div class="">
                        ...
                        <p class="m-0">gmr@railway.gov.lk</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 p-0">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="d-flex flex-column align-items-center justify-content-center bg-about rounded h-100 py-5 px-3">
                        ...
                        <h1 class="display-2 text-white mb-2" data-toggle="counter-up">170</h1>
                        <h2 class="text-white m-0">Years Experience</h2>
                    </div>
                </div>
                
                <div class="col-lg-7 pt-5 pb-lg-5">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">Learn About eRail Project</h6>
                    <h1 class="mb-4 section-title">We Provide The Best Solution</h1>
                    <p>The eRail Project aims to address the existing issues in the Sri Lankan railway system by developing and implementing a comprehensive digital solution. By digitalizing tablet signals, control signals, and automatic color light semaphore signals, the project aims to improve efficiency and safety in railway operations. The system will enable efficient and accurate communication between station masters and engine drivers, optimize signaling procedures, and enhance transit management. Additionally, the project will introduce real-time train tracking, cargo tracking, and a virtual tour experience to enhance the passenger and tourist experience. Furthermore, an auction method for seat reservation will be implemented to generate revenue and improve seat distribution. Overall, the eRail Project seeks to enhance the reliability, revenue generation, and passenger experience within the Sri Lankan railway industry.</p>
                    <div class="d-flex align-items-center pt-4">
                    <img src="/img/eRail_Logo.png" class="logo" width="100px" height="100px"> &nbsp &nbsp
    ...
    <div class="container-fluid bg-service py-5">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h6 class="text-secondary font-weight-semi-bold text-uppercase mb-3">Our Proposal</h6>
                    <h1 class="mb-4 section-title text-white">Revolutionizing Railways</h1>
                    <p class="text-white">The tablet exchanging system will benefit from this approach as it is digitalized. likewise change the semaphore signals into colored light signals. To inform the passengers of the delay and to give them a virtual tour of the entire journey. Through this system, facilities for transits management and cargo tracking will be offered. offered. Introducing the online auction mechanism for booking special railway seats.</p>
                    <a href="" class="btn btn-primary mt-3 py-2 px-4"> Services</a>
                </div>
                <div class="col-lg-6 pt-5 pt-lg-0">
                    <div class="owl-carousel service-carousel position-relative">
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <h5 class="font-weight-bold mb-4 px-4">eTablt</h5>
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            ...
                            <h5 class="font-weight-bold mb-4 px-4">eGuider</h5>
                            <img src="img/blog-3.jpg" alt="">
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            <div class="icon-box bg-light text-secondary shadow mt-2 mb-4">
                            <i class="fa fa-train" style="font-size:40px;"></i>
                            </div>
                            <h5 class="font-weight-bold mb-4 px-4">eTraveler</h5>
                            <img src="img/blog-2.jpg" alt="">
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded overflow-hidden pt-4">
                            <div class="icon-box bg-light text-secondary shadow mt-2 mb-4">
                            <i class="fa fa-gavel" style="font-size:40px;"></i>
                            </div>
                            <h5 class="font-weight-bold mb-4 px-4">eAuction</h5>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-7 pt-lg-5 pb-3">
                    ...
                    <h1 class="mb-4 section-title">170 Years Experience In Sri Lanka Railway</h1>
                    <p class="mb-4">Dolores lorem lorem ipsum sit et ipsum. Sadip sea amet diam dolore sed et. Sit rebum labore sit sit ut vero no sit. Et elitr stet dolor sed sit et sed ipsum et kasd ut. Erat duo eos et erat sed diam duo</p>
                    <div class="row">
                        <div class="col-sm-4">
                            <h1 class="text-secondary mb-2" data-toggle="counter-up">2550</h1>
                            <h6 class="font-weight-semi-bold mb-sm-4">Our Staff</h6>
                        </div>

                        <div class="col-sm-4">
                            <h1 class="text-secondary mb-2" data-toggle="counter-up">125</h1>
                ...
                <div class="col-lg-5" style="min-height: 400px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="img/Sri_Lanka_Railway_logo.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row align-items-end mb-4">
                <div class="col-lg-6">
                    <h1 class="section-title mb-3">Project Team</h1>
                </div>
                <div class="col-lg-6">
